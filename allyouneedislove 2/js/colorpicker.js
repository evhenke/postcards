...
function endMovement()
{
  ...
  document.getElementById("allyouneedislove").style.color = currentColor.HexString();
  document.getElementById("create").style.color = currentColor.HexString();
  document.getElementById("create").style.borderColor = currentColor.HexString();
  $(".heart1").css("fill",currentColor.HexString());
  $(".heart2").css("fill",currentColor.HexString());
